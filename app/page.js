      ...
      >
        ...
        <div className="flex flex-row gap-4 place-items-start">
          <button
            id="new-quote"
            onClick={handleClick}
            className="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 "
          >
            Generate
          </button>
          <a
          ...
          >
            <button
              type="button"
              className="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center  "
              disabled={isLoading}
            >
              <svg
